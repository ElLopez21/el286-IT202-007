...
<nav class = "navbar justify-content-center navbar-dark bg-dark">
    <ul class = "nav justify-content-center">
        <?php if (is_logged_in()) : ?>
            ...
            <li><a href="<?php echo get_url('car_list_samp.php'); ?>">Car List 2020</a></li>
        <?php endif; ?>
        <?php if (!is_logged_in()) : ?>
        ...
        <?php if (has_role("Admin")) : ?>
            ...
            <li><a href="<?php echo get_url("admin/car_create.php"); ?>"> Create Car</a></li>
            <li><a href="<?php echo get_url('admin/car_edit.php'); ?>">Edit Car</a></li>
        <?php endif; ?>
        <?php if (is_logged_in()) : ?>
